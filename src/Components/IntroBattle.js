        ...
        {playerTeam.length === 4 &&
          playerTeam.map((e, i) => 
              ...
              <div className="framePoke">
                ...
                <p>  Name : {e.name} <br/>Type : {e.types[0].type.name}<br/>Level : 100</p>
                </div>
              </div>
      ...
      <h1 className='gymleadtitle'>Which Gym Leader do you want to battle ?</h1>
                  <div className="gymleaders">
                    <div className="gymleadcolumn">
                     ...
                     <h1>Misty<br/>The Water type<br/> Pokemon Master !</h1>
                     ...
                     <h1>Lt. Surge<br/>The Electric type<br/> Pokemon Master !</h1>
                      ...
                      <h1>Erika<br/>The Grass type<br/> Pokemon Master !</h1>
