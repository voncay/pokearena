...
const BattleBrock = () => {
  ...
  const [opponent, setOpponent] = useState(aiteam.Brock.pokemon1)
...
return num ++
  ...
  //aiteam.Brock[Object.keys(aiteam.Brock)[indexOpponent]]
console.log(ai.Brock.pokemon1)
  const handleDamage = (damage) => {
    setOpponentHealth( h =>  h - damage > 0 ? h - damage : 0 )
  aiteam.Brock.pokemon1.pokemonHP === 0 && setOpponent(aiteam.Brock.pokemon2 )
  aiteam.Brock.pokemon2.pokemonHP === 0 && setOpponent(aiteam.Brock.pokemon3 )    
  aiteam.Brock.pokemon3.pokemonHP === 0 && setOpponent(undefined)

  
};
      
       // const keys = Object.keys(aiteam.Brock)
      // let index = keys.indexOf("pokemon1")
      
      // let nextPokemon = keys[index+1]
      // setOpponent(aiteam.Brock[nextPokemon])
      ...
      <>
        ...
        {showPokemon1 && (
          <div className="movelistarena">
            <h1 onClick={() => {
                setOpponentHealth(opponentHealth - battleTeam.pokemon1.pokemonAttacks.attackOne.damage); opponentHealth  <= 0 ? setOpponent(aiteam.Brock.pokemon2) : sequenceAi(); 
              }}
...
console.log(aiteam)
  const EnemyPokemon = () => {
    ...
    return(
      <div>
      { opponent === aiteam.Brock.pokemon1 &&
      <img className="aipokemon"src={aiteam.Brock.pokemon1.pokemonImg} alt="" />
      }
      { opponent === aiteam.Brock.pokemon2 &&
      <img className="aipokemon"src={aiteam.Brock.pokemon2.pokemonImg} alt="" />
      }
      { opponent === aiteam.Brock.pokemon3 &&
      <img className="aipokemon"src={aiteam.Brock.pokemon3.pokemonImg} alt="" />
      }
    ...
    return (
      <div className="brockpage">
        <div className="brockarenaframe">
          ...
          <p className="p2pokemoninfos">
            {aiteam.Brock.pokemon1.pokemonName}
            <br />
            Level : {aiteam.Brock.pokemon1.pokemonLevel}
            <br />
            HP : {aiteam.Brock.pokemon1.pokemonHP}
          </p>
          <img className="infoframeleft" src="/info_frame_left.png" alt="" />
        </div>
      </div>
