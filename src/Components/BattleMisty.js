...
const BattleMisty = () => {
  ...
  const [opponent, setOpponent] = useState(aiteam.Misty.pokemon1)
...
return num ++
  ...
  //aiteam.Misty[Object.keys(aiteam.Misty)[indexOpponent]]
console.log(ai.Misty.pokemon1)
  const handleDamage = (damage) => {
    setOpponentHealth( h =>  h - damage > 0 ? h - damage : 0 )
  aiteam.Misty.pokemon1.pokemonHP === 0 && setOpponent(aiteam.Misty.pokemon2 )
  aiteam.Misty.pokemon2.pokemonHP === 0 && setOpponent(aiteam.Misty.pokemon3 )    
  aiteam.Misty.pokemon3.pokemonHP === 0 && setOpponent(undefined)

  
};
      
       // const keys = Object.keys(aiteam.Misty)
      // let index = keys.indexOf("pokemon1")
      
      // let nextPokemon = keys[index+1]
      // setOpponent(aiteam.Misty[nextPokemon])
      ...
      <>
        ...
        {showPokemon1 && (
          <div className="movelistarena">
            <h1 onClick={() => {
                setOpponentHealth(opponentHealth - battleTeam.pokemon1.pokemonAttacks.attackOne.damage); opponentHealth  <= 0 ? setOpponent(aiteam.Misty.pokemon2) : sequenceAi(); 
              }}
...
console.log(aiteam)
  const EnemyPokemon = () => {
    ...
    return(
      <div>
      { opponent === aiteam.Misty.pokemon1 &&
      <img className="aipokemon"src={aiteam.Misty.pokemon1.pokemonImg} alt="" />
      }
      { opponent === aiteam.Misty.pokemon2 &&
      <img className="aipokemon"src={aiteam.Misty.pokemon2.pokemonImg} alt="" />
      }
      { opponent === aiteam.Misty.pokemon3 &&
      <img className="aipokemon"src={aiteam.Misty.pokemon3.pokemonImg} alt="" />
      }
    ...
    return (
      <div className="mistypage">
        <div className="mistyarenaframe">
          ...
          <p className="p2pokemoninfos">
            {aiteam.Misty.pokemon1.pokemonName}
            <br />
            Level : {aiteam.Misty.pokemon1.pokemonLevel}
            <br />
            HP : {aiteam.Misty.pokemon1.pokemonHP}
          </p>
          <img className="infoframeleft" src="/info_frame_left.png" alt="" />
        </div>
      </div>
