...
const BattleSurge = () => {
  ...
  const [opponent, setOpponent] = useState(aiteam.LtSurge.pokemon1)
...
return num ++
  ...
  //aiteam.LtSurge[Object.keys(aiteam.LtSurge)[indexOpponent]]
console.log(ai.LtSurge.pokemon1)
  const handleDamage = (damage) => {
    setOpponentHealth( h =>  h - damage > 0 ? h - damage : 0 )
  aiteam.LtSurge.pokemon1.pokemonHP === 0 && setOpponent(aiteam.LtSurge.pokemon2 )
  aiteam.LtSurge.pokemon2.pokemonHP === 0 && setOpponent(aiteam.LtSurge.pokemon3 )    
  aiteam.LtSurge.pokemon3.pokemonHP === 0 && setOpponent(undefined)

  
};
      
       // const keys = Object.keys(aiteam.LtSurge)
      // let index = keys.indexOf("pokemon1")
      
      // let nextPokemon = keys[index+1]
      // setOpponent(aiteam.LtSurge[nextPokemon])
      ...
      <>
        ...
        {showPokemon1 && (
          <div className="movelistarena">
            <h1 onClick={() => {
                setOpponentHealth(opponentHealth - battleTeam.pokemon1.pokemonAttacks.attackOne.damage); opponentHealth  <= 0 ? setOpponent(aiteam.LtSurge.pokemon2) : sequenceAi(); 
              }}
...
console.log(aiteam)
  const EnemyPokemon = () => {
    ...
    return(
      <div>
      { opponent === aiteam.LtSurge.pokemon1 &&
      <img className="aipokemon"src={aiteam.LtSurge.pokemon1.pokemonImg} alt="" />
      }
      { opponent === aiteam.LtSurge.pokemon2 &&
      <img className="aipokemon"src={aiteam.LtSurge.pokemon2.pokemonImg} alt="" />
      }
      { opponent === aiteam.LtSurge.pokemon3 &&
      <img className="aipokemon"src={aiteam.LtSurge.pokemon3.pokemonImg} alt="" />
      }
  ...
  const ShowActivePokemon1 = () => {
    return (
      <div className="surgepage">
        <div className="surgearenaframe">
          <img
    ...
    return (
      <div className="surgepage">
        <div className="surgearenaframe">
          ...
          <p className="p2pokemoninfos">
            {aiteam.LtSurge.pokemon1.pokemonName}
            <br />
            Level : {aiteam.LtSurge.pokemon1.pokemonLevel}
            <br />
            HP : {aiteam.LtSurge.pokemon1.pokemonHP}
          </p>
          <img className="infoframeleft" src="/info_frame_left.png" alt="" />
        </div>
      </div>
